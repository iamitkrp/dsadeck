...
export default function Home() {
  return (
    <main className="relative mx-auto min-h-[calc(100dvh-3rem)] max-w-7xl px-4 py-10 sm:px-6">
      {/* Decorative gradient and faded grid background */}
      <div className="pointer-events-none absolute inset-x-0 top-[-120px] -z-10 mx-auto h-[380px] w-[900px] rounded-full bg-gradient-to-br from-primary/25 via-fuchsia-400/20 to-cyan-400/20 blur-3xl opacity-50" />
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 -z-20 opacity-60"
        style={{
          backgroundImage:
            "linear-gradient(to right, rgba(120,120,140,.15) 1px, transparent 1px), linear-gradient(to bottom, rgba(120,120,140,.15) 1px, transparent 1px)",
          backgroundSize: "42px 42px",
          WebkitMaskImage: "radial-gradient(ellipse at top, black 50%, transparent 75%)",
